...
pub use artifact::{C4Artifact, C4ArtifactFormat, parse_file_from};
pub use likec4::LikeC4Workspace;

use std::path::Path;

pub fn load_workspace(root: &Path, docs_path: &Path, artifacts: &[C4Artifact]) -> LikeC4Workspace {
